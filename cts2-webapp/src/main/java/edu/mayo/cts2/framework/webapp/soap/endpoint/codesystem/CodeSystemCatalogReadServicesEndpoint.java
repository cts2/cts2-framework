...
public class CodeSystemCatalogReadServicesEndpoint extends AbstractReadServiceEndpoint {
  ...
  @PayloadRoot(localPart = "read", namespace = CTS2_NAMESPACE_ROOT + "CodeSystemCatalogReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "exists", namespace = CTS2_NAMESPACE_ROOT + "CodeSystemCatalogReadServices")
  @ResponsePayload
