...
public class ConceptDomainBindingReadServicesEndpoint extends AbstractReadServiceEndpoint {
  ...
  @PayloadRoot(localPart = "read", namespace = CTS2_NAMESPACE_ROOT + "ConceptDomainBindingReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "exists", namespace = CTS2_NAMESPACE_ROOT + "ConceptDomainBindingReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "readByURI", namespace = CTS2_NAMESPACE_ROOT + "ConceptDomainBindingReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "existsURI", namespace = CTS2_NAMESPACE_ROOT + "ConceptDomainBindingReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "getSupportedTag", namespace = CTS2_NAMESPACE_ROOT + "ConceptDomainBindingReadServices")
  @ResponsePayload
