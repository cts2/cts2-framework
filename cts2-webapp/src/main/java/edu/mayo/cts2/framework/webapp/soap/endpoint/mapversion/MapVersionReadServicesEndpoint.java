...
public class MapVersionReadServicesEndpoint extends AbstractReadServiceEndpoint {
  ...
  @PayloadRoot(localPart = "read", namespace = CTS2_NAMESPACE_ROOT + "MapVersionReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "readMapVersionForMap", namespace = CTS2_NAMESPACE_ROOT + "MapVersionReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "readEntry", namespace = CTS2_NAMESPACE_ROOT + "MapVersionReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "exists", namespace = CTS2_NAMESPACE_ROOT + "MapVersionReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "existsMapVersionForMap", namespace = CTS2_NAMESPACE_ROOT + "MapVersionReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "entryExists", namespace = CTS2_NAMESPACE_ROOT + "MapVersionReadServices")
  @ResponsePayload
