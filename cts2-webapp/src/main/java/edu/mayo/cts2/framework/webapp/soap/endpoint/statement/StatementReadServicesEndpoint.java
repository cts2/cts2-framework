...
public class StatementReadServicesEndpoint extends AbstractReadServiceEndpoint {
  ...
  /* TODO: implement read */
  @PayloadRoot(localPart = "read", namespace = CTS2_NAMESPACE_ROOT + "StatementReadServices")
  @ResponsePayload
...
//    return response;
  ...
  @PayloadRoot(localPart = "exists", namespace = CTS2_NAMESPACE_ROOT + "StatementReadServices")
  @ResponsePayload
