...
public class CodeSystemVersionCatalogReadServicesEndpoint extends AbstractReadServiceEndpoint {
  ...
  @PayloadRoot(localPart = "read", namespace = CTS2_NAMESPACE_ROOT + "CodeSystemVersionCatalogReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "exists", namespace = CTS2_NAMESPACE_ROOT + "CodeSystemVersionCatalogReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "existsCodeSystemVersionForCodeSystem", namespace = CTS2_NAMESPACE_ROOT + "CodeSystemVersionCatalogReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "existsVersionId", namespace = CTS2_NAMESPACE_ROOT + "CodeSystemVersionCatalogReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "getCodeSystemVersionForCodeSystem", namespace = CTS2_NAMESPACE_ROOT + "CodeSystemVersionCatalogReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "getCodeSystemByVersionId", namespace = CTS2_NAMESPACE_ROOT + "CodeSystemVersionCatalogReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "getSupportedTag", namespace = CTS2_NAMESPACE_ROOT + "CodeSystemVersionCatalogReadServices")
  @ResponsePayload
