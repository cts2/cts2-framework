...
public class ConceptDomainCatalogReadServicesEndpoint extends AbstractReadServiceEndpoint {
  ...
  @PayloadRoot(localPart = "read", namespace = CTS2_NAMESPACE_ROOT + "ConceptDomainCatalogReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "readByDefiningEntity", namespace = CTS2_NAMESPACE_ROOT + "ConceptDomainCatalogReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "exists", namespace = CTS2_NAMESPACE_ROOT + "ConceptDomainCatalogReadServices")
  @ResponsePayload
  ...
  @PayloadRoot(localPart = "existsDefiningEntity", namespace = CTS2_NAMESPACE_ROOT + "ConceptDomainCatalogReadServices")
  @ResponsePayload
