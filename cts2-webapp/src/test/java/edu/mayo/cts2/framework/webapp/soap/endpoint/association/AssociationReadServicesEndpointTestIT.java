...
public class AssociationReadServicesEndpointTestIT extends SoapEndpointTestBase {
  ...
  private class MockService extends MockBaseService implements AssociationReadService {
    ...
    public LocalIdAssociation readByExternalStatementId(String externalStatementId, String scopingNamespaceName, ResolvedReadContext readContext) {
      ...
      return new LocalIdAssociation("1", association);
    }
    ...
    public LocalIdAssociation read(AssociationReadId identifier, ResolvedReadContext readContext) {
      Association association = new Association();
