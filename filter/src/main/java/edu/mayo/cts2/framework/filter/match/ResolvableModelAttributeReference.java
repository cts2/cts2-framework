 ...
 */
public class ResolvableModelAttributeReference<T> extends ModelAttributeReference implements MarshallSuperClass {
	 ...
	 * @param ref the ref
	 * @param attributeResolver the attribute resolver
	 * @return the resolvable model attribute reference
	 */
	public static <T> ResolvableModelAttributeReference<T> toModelAttributeReference(
			ModelAttributeReference ref, AttributeResolver<T> attributeResolver){
		ResolvableModelAttributeReference<T> returnRef = 
			new ResolvableModelAttributeReference<T>(attributeResolver);
