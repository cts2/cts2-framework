...
/**
 * The Class ResolvedValueSetReference.
 *
...
public class ResolvedValueSetReference {
	...
	/**
	 * Gets the value set definition reference.
	 *
	 * @return the value set definition reference
	 */
	...
	/**
	 * Sets the value set definition reference.
	 *
	 * @param valueSetDefinitionReference the new value set definition reference
	 */
