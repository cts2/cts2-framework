...
public class MapEntryId {
	...
	private ScopedEntityName mapFrom;
	...
	public ScopedEntityName getMapsFrom() {
		return mapFrom;
	}

	public void setMapFrom(ScopedEntityName mapFrom) {
		this.mapFrom = mapFrom;
	}
	
	/**
	 * Builds the map entry id.
	 *
	 * @param mapVersion the map version
	 * @param encodedEntityName the encoded entity name
	 * @return the map entry id
	 */
	public static MapEntryId buildMapEntryId(String mapVersion, String encodedEntityName){
