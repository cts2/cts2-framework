...
class ClassPathScanningConformanceFactoryTest {
	...
	void testFindAnnotations(){
		def functionalConformance = factory.findAnnotations(TestCsReadService.class, FunctionalConformance.class)
		
		def structuralConformance = factory.findAnnotations(TestCsReadService.class, StructuralConformance.class)
