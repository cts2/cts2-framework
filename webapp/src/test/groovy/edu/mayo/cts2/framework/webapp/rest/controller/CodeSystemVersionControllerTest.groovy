...
import edu.mayo.cts2.framework.webapp.naming.CodeSystemVersionNameResolver
 ...
 class CodeSystemVersionControllerTest {
	...
	void testGetCodeSystemVersionByNameOrOfficialResourceVersionIdInstanceOfMessage(){
		def result = 
			controller.getCodeSystemVersionByNameOrOfficialResourceVersionId(httpServletRequest, null, new QueryControl(), "csname", "csvname").getBody()
	...
	void testGetCodeSystemVersionByNameOrOfficialResourceVersionIdNameHasEverything(){
		def result = controller.getCodeSystemVersionByNameOrOfficialResourceVersionId(httpServletRequest, null, new QueryControl(), "csname", "csvname").getBody()
